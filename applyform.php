                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" action="applyform.php">
                                <div class="form-floating mb-3">
                                    <input name="name" type="text" class="form-control" id="floating4"
                                         required>
                                    <label for="floating4">Name</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="ndp" type="number" class="form-control" id="floating3"
                                         required>
                                    <label for="floating3">NDP</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input name="sem" type="number" class="form-control" id="floating20"
                                         required>
                                    <label for="floating20">Semester</label>
                                </div>
       
                                <div class="form-floating mb-3">
                                    <input name="phonen" type="text" class="form-control" id="floating18"
                                         required>
                                    <label for="floating18">Phone Number </label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input name="hphonen" type="text" class="form-control" id="floating17"
                                         required>
                                ...
                                <div class="form-floating mb-3">
                                    <input name="ic" type="text" class="form-control" id="floating5"
                                         required>
                                ...
                                <div class="form-floating mb-3">
                                    <input name="race" type="text" class="form-control" id="floating9"
                                         required>
                                    <label for="floating9">Race</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="religion" type="text" class="form-control" id="floating10"
                                         required>
                                    <label for="floating10">Religion</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="course" type="text"  class="form-control" id="floating6"
                                         required>
                                    <label for="floating6">Course Code</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="session_num" type="text" class="form-control" id="floating7"
                                         required>
                                    <label for="floating7">Admission Session</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="address" type="text" class="form-control" id="floating21"
                                         required>
                                    <label for="floating21">Address</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input name="fathern" type="text" class="form-control" id="floating11"
                                         required>
                                    <label for="floating11">Father's Name</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="fatherc" type="text" class="form-control" id="floating12"
                                         required>
                                    <label for="floating12">Father's Career</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="fatherp" type="text" class="form-control" id="floating13"
                                         required>
                                    <label for="floating13">Father's Phone Number</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input name="mothern" type="text" class="form-control" id="floating14"
                                         required>
                                    <label for="floating14">Mother's Name</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="motherc" type="text" class="form-control" id="floating15"
                                         required>
                                    <label for="floating15">Mother's Career</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input name="motherp" type="text" class="form-control" id="floating16"
                                         required>
